...
<div style="overflow-x:auto;">
  <table>
    ...
    <%Object olistabr = session.getAttribute("listabr");%>
	...
	<% List<ListarBarberoInterno> slistabr = (List<ListarBarberoInterno>) olistabr; %>
	
	<% for(ListarBarberoInterno lbr: slistabr) { %>
