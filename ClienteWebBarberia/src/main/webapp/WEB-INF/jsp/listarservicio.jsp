...
<body>
<p></p>
<h4 align="center"><b>LISTADO DE SERVICIOS</b></h4>
...
<div style="overflow-x:auto;">
  <table>
    ...
    <%Object olistasv = session.getAttribute("listasv");%>
	...
	<% List<ListarServicioInterno> slistasv = (List<ListarServicioInterno>) olistasv; %>
	
	<% for(ListarServicioInterno lsv: slistasv) { %>
