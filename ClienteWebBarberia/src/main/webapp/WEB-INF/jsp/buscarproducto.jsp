...
<div style="overflow-x:auto;">
  <table>
    ...
    <%Object obuzkpro = session.getAttribute("buzkpro");%>
	...
	<% List<BuscarProductoInterno> sbuzkpro = (List<BuscarProductoInterno>) obuzkpro; %>
	
	<% for(BuscarProductoInterno listapr: sbuzkpro) { %>
