...
public class RecuperarServicio implements Serializable
{
...
private final static long serialVersionUID = -1532836101516797883L;

/**
* No args constructor for use in serialization
* 
*/
public RecuperarServicio() {
}
...
* @param cidEstado
*/
public RecuperarServicio(String bnombser, int cidEstado, int dminutos, double eprecio, String fdescripcion) {
super();
...
public RecuperarServicio withBnombser(String bnombser) {
this.bnombser = bnombser;
return this;
}
...
public RecuperarServicio withCidEstado(int cidEstado) {
this.cidEstado = cidEstado;
return this;
}
...
public RecuperarServicio withDminutos(int dminutos) {
this.dminutos = dminutos;
return this;
}
...
public RecuperarServicio withEprecio(double eprecio) {
this.eprecio = eprecio;
return this;
}
...
public RecuperarServicio withFdescripcion(String fdescripcion) {
this.fdescripcion = fdescripcion;
return this;
}
...
public RecuperarServicio withAdditionalProperty(String name, Object value) {
this.additionalProperties.put(name, value);
return this;
}
